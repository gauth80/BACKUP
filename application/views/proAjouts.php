                ...
                <?= form_open_multipart('produits/create_produits', ["class" => " row col-sm-12 col-lg-9 p-2 m-5"]); ?>
                    <h3 class="titre-form-produits col-11 offset-1 mt-2">Ajout de produits</h3>
                <?php validation_errors();?>
                    <div class="form-group row col-11 offset-1">

                        <label for="catExist" class="offset-1 offset-1">Choisir une catégorie *</label>
                    ...
                    <div class="form-group row col-11 offset-1 <?= empty(form_error('pro_lib')) ? '' : 'has-error';?>">
                        <label for="libelle" class="offset-1 col-11">Le libelle&nbsp;:&nbsp;*</label>
                    ...
                    <div class="form-group row col-11 offset-1 <?= empty(form_error('pro_ref')) ? '' : 'has-error';?>">
                        <label for="ref" class="offset-1 col-11">La ref&nbsp;:&nbsp;*</label>
                    ...
                    <div class="form-group row col-11 offset-1 <?= empty(form_error('pro_prix')) ? '' : 'has-error';?>">
                        <label for="prix" class="offset-1 col-11">Définir un prix&nbsp;:&nbsp;*</label>
                    ...
                    <div class="form-group row col-11 offset-1 <?= empty(form_error('pro_stock')) ? '' : 'has-error';?>">
                        <label for="stock" class="offset-1 col-11">Entrer un stock&nbsp;:&nbsp;*</label>
                    ...
                    <div class="form-group row col-11 offset-1 <?= empty(form_error('pro_desc')) ? '' : 'has-error';?>">
                        <label for="desc" class="offset-1 col-11">Indiquez une description&nbsp;:&nbsp;*</label>
                    ...
                    <div class="form-group row col-11 offset-1 <?= empty(form_error('err_img')) ? '' : 'has-error';?>">
                        <label for="stock" class="offset-1 col-11">Inserez une image&nbsp;:&nbsp;*</label>
                ...
                <?= form_submit("create_pro", "Envoyez", ["class" => "btn btn-custom my-2 row col-sm-auto offset-2 px-2"], ["type" => "submit"]);?>
                <?= form_close(); ?>

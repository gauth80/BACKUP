                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-8 col-xl-12 offset-1">
                    ...
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("fournisseurs/fourni_list");?>" class="btn btnperss offset-2 col-auto ml-5" > Fournisseurs</a>
                        </article>
                    </section>
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("produits/list");?>" class="btn btnperss offset-2 col-auto ml-5"> Produits</a>
                        </article>
                    </section>
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("categories/cat_list");?>" class="btn btnperss offset-2 col-auto ml-5"> Categories</a>
                        </article>
                    </section>
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("clients/cli_list");?>" class="btn btnperss offset-2 col-auto ml-5" > Clients</a>
                        </article>
                    </section>
                    <section class="mb-5">
                        <article>
                            ...
                            <a href="<?php echo site_url("personnels/pers_list");?>" class="btn btnperss offset-2 col-auto ml-5" > Personnel</a>
                        </article>
                    </section>
                </div>
            </div>

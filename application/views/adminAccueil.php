                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-8 col-xl-12">
                    ...
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("fournisseurs/fourni_list");?>" class="btn btn-dark offset-3 col-auto" target="_blank"> Fournisseurs</a>
                        </article>
                    </section>
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("produits/list");?>" class="btn btn-dark offset-3 col-auto"> Produits</a>
                        </article>
                    </section>
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("categories/cat_list");?>" class="btn btn-dark offset-3 col-auto"> Categories</a>
                        </article>
                    </section>
                    <section>
                        <article>
                            ...
                            <a href="<?php echo site_url("clients/cli_list");?>" class="btn btn-dark offset-3 col-auto" target="_blank"> Clients</a>
                        </article>
                    </section>
                    <section class="mb-5">
                        <article>
                            ...
                            <a href="<?php echo site_url("personnels/pers_list");?>" class="btn btn-dark offset-3 col-auto" target="_blank"> Personnel</a>
                        </article>
                    </section>
                </div>
            </div>

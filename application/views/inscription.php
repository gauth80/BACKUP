<?= form_open("jarditou/inscription", 'class="form_control"'); ?>
<br>
<!-- Nom -->
...
<div class="form-group text-center offset-3 w-50">
    ...
    <input type="password" class="form-control" id="v_mdp" name="v_mdp" placeholder="Ré-entreez votre mot de passe">
</div>
...
<div class="text-center offset-3 w-50">
    <a href="<?php echo site_url("jarditou/connexion"); ?>"> Déjà inscrit ? </a>
</div>
<br>
<?= form_close(); ?>